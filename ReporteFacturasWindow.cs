...
public class ReporteFacturasWindow : Window
{
    public ReporteFacturasWindow() : base("Reporte de Facturación")
    {
        SetDefaultSize(400, 200);
        SetPosition(WindowPosition.Center);

        Box vbox = new Box(Orientation.Vertical, 5);
        Label label = new Label("Generar Reporte de Facturación:");
