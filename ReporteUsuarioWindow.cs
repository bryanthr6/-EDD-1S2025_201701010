...
public class ReporteUsuarioWindow : Window
{
    public ReporteUsuarioWindow() : base("Reporte de Usuarios")
    {
        SetDefaultSize(400, 200);
        SetPosition(WindowPosition.Center);

        Box vbox = new Box(Orientation.Vertical, 5);
        Label label = new Label("Generar Reporte de Usuarios:");
    ...
    {
        Program.usuarios.GenerarReporteUsuarios();
